                ...
                Ok(m) => match m.header.message_type {
                    ...
                    IO_PORT_INTERCEPT_MESSAGE => {
                        ...
                        if is_io_in {
                            ...
                            return Ok(HyperlightExit::IoIn(port, access_size as u8));
                        } else {
                            // === IO OUT ===
                            ...
                            return Ok(HyperlightExit::IoOut(
                                port,
                    ...
                    UNMAPPED_GPA_MESSAGE => {
                        ...
                        return match MemoryRegionFlags::try_from(mimo_message)? {
                            MemoryRegionFlags::READ => Ok(HyperlightExit::MmioRead(addr)),
                            MemoryRegionFlags::WRITE => Ok(HyperlightExit::MmioWrite(addr)),
                            _ => Ok(HyperlightExit::Unknown(
                    ...
                    INVALID_GPA_ACCESS_MESSAGE => {
                        ...
                        return match access_info {
                            MemoryRegionFlags::READ => Ok(HyperlightExit::MmioRead(gpa)),
                            MemoryRegionFlags::WRITE => Ok(HyperlightExit::MmioWrite(gpa)),
                            _ => Ok(HyperlightExit::Unknown(
                                "Unknown MMIO access".to_string(),
                            )),
                        };
                    ...
                    EXCEPTION_INTERCEPT => {
                        ...
                        return Ok(HyperlightExit::Debug {
                            dr6,
                            exception: ex_info.exception_vector as u32,
                        });
                    }
                    other => {
                        return Ok(HyperlightExit::Unknown(format!(
