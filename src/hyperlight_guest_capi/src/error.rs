...
use hyperlight_guest_bin_shim::guest_error::setError;
...
pub extern "C" fn hl_abort_with_code(err: i32) {
    hyperlight_guest::out::abort_with_code(&[err as u8]);
}

#[no_mangle]
pub extern "C" fn hl_abort_with_code_and_message(err: i32, message: *const c_char) {
    unsafe { hyperlight_guest::out::abort_with_code_and_message(&[err as u8], message) };
}
